...
export default class ContactScreen extends React.Component {
  ...
  render() {
    ...
    const image =
      theme.key === 'dark' ? require('src/assets/images/privacyDark.png') : require('src/assets/images/privacy.png');

    return (
      <ThemedView style={styles.full}>
        <Header
          leftComponent={<IconHeader />}
          centerComponent={<TextHeader title={t('common:text_privacypolicy')} />}
          rightComponent={<CartIcon />}
        />
        <ScrollView>
          <Container>
            <Text h2 medium>
              {t('common:text_privacypolicy')}
            </Text>
            ...
            <View style={styles.viewImage}>
              ...
              <Text style={{ color: theme.AboutUsScreen.researchColor }}>{t('profile:text_privacytxt')}</Text>
              <Image source={require('src/assets/images/ux.png')} resizeMode="stretch" />
            </View>
            <Text style={styles.description} colorSecondary>
              {t('profile:text_privacypolicy_description')}
            </Text>
          </Container>
        </ScrollView>
      </ThemedView>
