...
export default class ContactScreen extends React.Component {
  ...
  render() {
    ...
    const image =
      theme.key === 'dark' ? require('src/assets/images/termsDark.png') : require('src/assets/images/terms.png');

    return (
      <ThemedView style={styles.full}>
        <Header
          leftComponent={<IconHeader />}
          centerComponent={<TextHeader title={t('common:text_termsandconditions')} />}
          rightComponent={<CartIcon />}
        />
        <ScrollView>
          <Container>
            <Text h2 medium>
              {t('common:text_termsandconditions')}
            </Text>
            ...
            <View style={styles.viewImage}>
              ...
              <Text style={{ color: theme.AboutUsScreen.researchColor }}>{t('profile:text_terms')}</Text>
              <Image source={require('src/assets/images/ux.png')} resizeMode="stretch" />
            </View>
            <Text style={styles.description} colorSecondary>
              {t('profile:text_termsandconditions_description')}
            </Text>
          </Container>
        </ScrollView>
      </ThemedView>
