...
export default class ContactScreen extends React.Component {
  ...
  render() {
    ...
    const image =
      theme.key === 'dark' ? require('src/assets/images/returnDark.png') : require('src/assets/images/return.png');

    return (
      <ThemedView style={styles.full}>
        <Header
          leftComponent={<IconHeader />}
          centerComponent={<TextHeader title={t('common:text_returnpolicy')} />}
          rightComponent={<CartIcon />}
        />
        <ScrollView>
          <Container>
            <Text h2 medium>
              {t('common:text_returnpolicy')}
            </Text>
            ...
            <View style={styles.viewImage}>
              ...
              <Text style={{ color: theme.AboutUsScreen.researchColor }}>{t('profile:text_return')}</Text>
              <Image source={require('src/assets/images/ux.png')} resizeMode="stretch" />
            </View>
            <Text style={styles.description} colorSecondary>
              {t('profile:text_returnpolicy_description')}
            </Text>
          </Container>
        </ScrollView>
      </ThemedView>
